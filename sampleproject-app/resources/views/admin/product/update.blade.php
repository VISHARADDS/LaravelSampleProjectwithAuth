...
<div style="@if (isset($products->id) && $products->photo !='') background-image: url('{{ url('/')}}/uploads/{{ $products->photo}}')@else background-image:url('{{url('/image/avatar.png' )}}')@endif" id="imagePreview"></div>
