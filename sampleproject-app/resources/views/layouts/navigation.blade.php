<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <a href="{{ route('dashboard') }}">
        ...
        <span style="font-weight: 900; letter-spacing: 2px; font-family: Arial, sans-serif;">TECH DEAL</span>
    </a>
</div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2  border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <div class="ms-1">
                            <i style="margin-top:5px; color:black" class="material-icons opacity-10">arrow_drop_down</i>
                            </div>
                        </button>
                    </x-slot>
